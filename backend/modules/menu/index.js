    ...
    handler: function (request, h) {
        let data = {
        	...
        	breadcrumb:
                [
                    {title:'Menu','url':'/menu'},
                    {title:'Add new menu','url':'/menu/new'},
                ],
            active_menu:true,
        }; 
        return h.view('menu/new',data);
    }
}
...
exports.edit = {
    handler: async function (request, h) {
        ...
        let menu = await this.helpers.fetchapi(uri,'get');
        //return menu;
        let data = {
          title: 'Edit Menu',
      	  breadcrumb:
...
exports.delete = {
    handler: async function (request, h) {
        ...
        let uri = this.api_url+'/menu/'+id;
        let result = await this.helpers.fetchapi(uri,'delete');
        //console.log(result);
        return result;
